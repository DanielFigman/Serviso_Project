...
const FoodCard = ({ item, setCart, cart }) => {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.detailsContainer}>
                    ...
                    <ButtonMain text="Add" textStyle={styles.addButton} buttonStyle={styles.addButtonContainer} onPress={() => setCartModalVisible(true)} />
    ...
    }, [item, quantity, modalVisible, descModalVisible, cartModalVisible, isPressedWithZero]);
