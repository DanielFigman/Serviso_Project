...
const NearByBottom = ({ item, setPanResponderEnabled }) => {
  ...
  const screenContent = Languages.NearByBottom;
        ...
        <>
          ...
          <View style={styles.view}>
            <Text style={styles.category}>
              {MakeTheFirstLetterUpperCase(item.category)}
            </Text>
          </View>
          ...
          >
            <Text
              style={[
                styles.category,
                { marginTop: 16, textDecorationLine: "underline" },
              ]}
            >
              {screenContent.ViewDescription[language]}
            </Text>
          </TouchableOpacity>
          <DescriptionDialaog
          ...
          >
            <ImagesCarouselNearBottom
              urlList={item.morePhotosUrls}
              image={item.imageURL}
            />
          </View>
