...
const RoomCleaningScreen = () => {
  ...
  const { order, checkIfAlreadyScheduledAcleaning, scheduledOrder } =
    useContext(HotelsAppContext);
  const toggleSwitch = () => setIsEnabled((previousState) => !previousState);

  const { language } = useContext(HotelsAppContext);
  const screenContent = Languages.RoomCleaningScreen;
  ...
  return (
    <ScreenComponent
      title={
        <Text
          style={{ fontWeight: "bold", fontSize: 30, marginHorizontal: 30 }}
        >
          {screenContent.CleaningSchedule[language]}
        </Text>
      }
      content={
        scheduledOrder ? (
          <View>
            <View>
              ...
              <Image
                ...
                source={require("../../assets/check-done.png")}
              />
            </View>
          </View>
        ) : (
          <View style={styles.container}>
            ...
            >
              <View
                style={[
                  { flexDirection: "row", paddingBottom: 70, zIndex: 1 },
                  isEnabled && { opacity: 0.2, pointerEvents: "none" },
                ]}
              >
              ...
              <View style={{ flexDirection: "col", alignItems: "center" }}>
                ...
                >
                  ...
                  <Switch
                    ...
                    style={{ marginLeft: 20 }}
                    onChange={(value) => {
                      console.log("I don't want a clean room");
                    }}
                    value={isEnabled}
                  />
                </View>
