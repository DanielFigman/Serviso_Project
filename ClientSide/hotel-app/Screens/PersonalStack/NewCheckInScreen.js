        ...
        <>
          ...
          <View style={{ marginTop: -lowerViewMarginTop }}>
            <Text style={styles.commentText}>
              {screenContent.PleaseReviewYourReservation[language]}
            </Text>
            <ReservationCard
              title={screenContent.Name[language]}
              value={fullName}
            />
            <ReservationCard
              title={screenContent.CheckIn[language]}
              value={formattedCheckInDate}
            />
            <ReservationCard
              title={screenContent.CheckOut[language]}
              value={formattedCheckOutDate}
            />
            <ReservationCard
              title={screenContent.EstimatedTotal[language]}
              value={estimatedPrice}
            />
            <ButtonMain
              text={screenContent.Next[language]}
              buttonStyle={{ marginTop: 20, height: 40, padding: 0 }}
